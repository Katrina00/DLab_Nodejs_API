...
router.get('/myprofile', auth(), awaitHandlerFactory(userController.getCurrentUser)); // localhost:3000/api/v1/users/myprofile
router.get('/premium', auth(Role.Premium), awaitHandlerFactory(userController.getPremiumList)); // localhost:3000/api/v1/users/premium
